...
const MusicPlayer = () => {
  ...
  const tracks = [
    {
      ...
      image:
        "https://e7.pngegg.com/pngimages/490/1002/png-clipart-music-mp3-android-music-download-free-music-thumbnail.png",
    },
    {
      title: "Track 2",
  ...
  return (
    <div className="music-player">
      ...
      />
      <audio src={tracks[currentMusicTrack].source} ref={audioRef} />
